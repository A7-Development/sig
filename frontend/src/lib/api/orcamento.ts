...
export const cenariosApi = {
  ...
  updateCliente: (token: string, cenarioId: string, clienteId: string, data: Partial<CenarioCliente>) =>
    api.put<CenarioCliente>(`/api/v1/orcamento/cenarios/${cenarioId}/clientes/${clienteId}`, data, token),
  ...
  getClienteSecoes: (token: string, cenarioId: string, clienteId: string) =>
    api.get<CenarioSecao[]>(`/api/v1/orcamento/cenarios/${cenarioId}/clientes/${clienteId}/secoes`, token),
  ...
  updateClienteSecao: (token: string, cenarioId: string, clienteId: string, secaoId: string, data: Partial<CenarioSecao>) =>
    api.put<CenarioSecao>(`/api/v1/orcamento/cenarios/${cenarioId}/clientes/${clienteId}/secoes/${secaoId}`, data, token),
